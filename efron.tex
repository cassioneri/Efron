...
\title{On Continuous Efron's Dice\footnote{%
  ...
  \href{http://github.com/cassioneri/Efron}
  {github.com/cassioneri/Efron}
  \newline
...
\hfill\includegraphics[width=6cm]{grid6CxD.eps}
\hfill\
...
\begin{figure}[ht]
\hfill\includegraphics[width=6cm]{grid6i3j3.eps}
\hfill\
...
\begin{figure}[ht]
\hfill\includegraphics[width=6cm]{grid8.eps}
\hfill\includegraphics[width=6cm]{grid8i4j4.eps}
\hfill\
